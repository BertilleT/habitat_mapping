...
model_settings = {
    ...
    'path_to_best_model': f'../{config_name}/models/unet_intermed_epoch10.pt',#f'../{config_name}/models/unet_intermed_epoch35.pt',#f'../{config_name}/models/unet_intermed_epoch3.pt',
}
